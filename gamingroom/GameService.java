...
public class GameService {
	...
	// instance of GameService is stored in service if it does not exist.
	private static GameService service = null;
	
	// empty constructor
	private GameService(){}
	
	// checks if GameService exists and makes one if it does not
	...
	public Game addGame(String name) {
		...
		// if not found make game and add to list
		if (game == null) {
	...
	public Game getGame(long id) {
		...
		// if found, assign instance to the local variable
